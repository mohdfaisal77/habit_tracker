...
//           Slider(value: _age, min: 18, max: 100, onChanged: (value) => setState(() => _age = value)),
//           DropdownButton<String>(
//             value: _country,
//             onChanged: (newValue) => setState(() => _country = newValue!),
//             items: ['United States', 'Canada', 'India'].map((country) => DropdownMenuItem(value: country, child: Text(country))).toList(),
//           ),
